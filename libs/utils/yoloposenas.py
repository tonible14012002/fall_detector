...
from libs.pose.posenas import (
    YoloNasPosePredictor,
    YoloNasPoseEstimator,
)
...
def new_yolovnas_pose_estimator(device="cpu"):
    pose_estimator = YoloNasPoseEstimator.new(
